...
function Switch({
  ...
  VariantProps<typeof switchVariants> & { thumbClassName?: string; label?: string }) {
  ...
  return (
    <label className="flex items-center gap-3 cursor-pointer group select-none">
      {switchNode}
      <span className="text-[13px] font-bold text-text-main group-hover:text-primary transition-colors">
        {label}
      </span>
    </label>
  );
